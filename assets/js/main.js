...
hamburgerAnimation.to('#hamburger .top', {y: 28, ease: 'back', duration:0.3})
                  ...
                  .to('#hamburger .top', {
                    ...
                    y: 33,
                    rotate: 45,
                    transformOrigin: 'center', duration: 0.2,
                    ease: 'back'
                  })
                  .to('#hamburger .bottom', {
                    x: 7,
                  ...
                  .from('nav .mobile-list .social-links a', {
                    y: 10,
                    scale: 0.5,
                    opacity: 0,
                    stagger: {
...
heroAnimation.from('#Hero-Sec', {opacity:0, duration:1})
             ...
             .from('#Hero-Sec .content-wrapper .col-left a', {
              opacity: 0,
              y: 40,
             }, '<')
             .from('#Hero-Sec .content-wrapper .col-right img', {
              yPercent: 115,
              ease: 'back',
             }, 1)
